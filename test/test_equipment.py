...
from pygrocydm.equipment import EQUIPMENTS_ENDPOINT, Equipment
...
class TestEquipment(TestCase):
    ...
    def setUp(self):
        ...
        self.endpoint = EQUIPMENTS_ENDPOINT + '/1'
    ...
    def test_parse_json(self):
        equipment = Equipment(self.api, EQUIPMENTS_ENDPOINT, self.api.get_request(self.endpoint))
        ...
        assert isinstance(equipment.instruction_manual_file_name, str) or equipment.instruction_manual_file_name is None
